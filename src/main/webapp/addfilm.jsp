    ...
    <div class="column">
        <form  action="addMovies" method="post">
            <table class="table-add" border="0">
                ...
                <tr><td>类别:</td><td><input type="text" name="movies.mType" ></td></tr>
                <tr><td>导演:</td><td><input type="text" name="movies.mDirector"></td></tr>
                <tr><td>演员:</td><td><input type="text" name="movies.mActor"></td></tr>
                <tr><td>国家:</td><td><input type="text" name="movies.mCountry" ></td></tr>
                <tr><td>语言:</td><td><input type="text" name="movies.mLanguage"></td></tr>
